...
const std::map<uint8_t, uint16_t> noTransmapping{{0x0, Test2BitBGColor},
                                                 {0x1, LerpColor(Test2BitBGColor, Test2BitFGColor, lowLerpThres)},
                                                 {0x2, LerpColor(Test2BitBGColor, Test2BitFGColor, highLerpThres)},
                                                 {0x3, Test2BitFGColor}};

const std::map<uint8_t, uint16_t> withTransMapping{
    {0x0, Test2BitTransparentColor},
    {0x1, LerpColor(Test2BitTransparentColor, Test2BitFGColor, lowLerpThres)},
    {0x2, LerpColor(Test2BitTransparentColor, Test2BitFGColor, highLerpThres)},
    {0x3, Test2BitFGColor}};
